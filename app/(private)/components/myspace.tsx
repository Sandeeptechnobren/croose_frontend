...
// import Scanqrpage from './scanqr'
// import Spacenav from './spacenav'
// import { RunAgent, spaceChats, spaceIqCheck, spaceLiveChats, PayApi, RunAgentInfo } from "@/app/Apis/publicapi";
// import { useParams, useSearchParams } from 'next/navigation';
// import { useIq } from '../Iqcontext'
// import LiveAgent2 from './liveagent2'
// import Link from 'next/link'
...
//         // Extract and store the space_uuid from the response
//         if (res?.space_uuid) {
//           setSpaceUuid(res.space_uuid);
//           console.log("Space UUID set:", res.space_uuid);
//         }
//       } catch (err) {
//         console.log(err);
//       }
...
//   const handleRunAgent = async () => {
//   try {
//     console.log("DEBUG spaceUuid before calling API:", spaceUuid, typeof spaceUuid);

//     if (!spaceUuid || spaceUuid.trim() === "") {
//       alert("UUID missing. Please wait for space data to load or refresh.");
//       return;
//     }

//     setLoading(true);
//     const response = await RunAgentInfo(spaceUuid);
...
//       alert("Space not found. Please verify the space exists.");
//     } else if (err?.response?.status === 401) {
//       alert("Authentication failed. Please login again.");
//     } else {
//       alert("Failed to run agent. Please try again later.");
//     }
//   } finally {
//     setLoading(false);
//   }
...
//       {proopen ? <Upgradetopro setProopen={setProopen} space_uuid={spaceUuid} /> : ""}

//       {scanopen ? <Scanqrpage setScanopen={setScanopen} space_id={id} space_uuid={spaceUuid} /> : ""}
...
// import Scanqrpage from './scanqr'
// import Spacenav from './spacenav'
// import { RunAgent, spaceChats, spaceIqCheck, spaceLiveChats, PayApi } from "@/app/Apis/publicapi";
// import { useParams, useSearchParams } from 'next/navigation';
// import { useIq } from '../Iqcontext'
// import LiveAgent2 from './liveagent2'
// const Myspace = () => {
